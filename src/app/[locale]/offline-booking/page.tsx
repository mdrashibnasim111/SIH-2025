...
const DoctorCard = ({ doctor }: { doctor: typeof doctors[0] }) => {
    ...
    const handleBooking = () => {
        ...
        const timeSlots = ["10:00 AM - 10:30 AM", "11:00 AM - 11:30 AM", "12:00 PM - 12:30 PM", "02:00 PM - 02:30 PM"];
        const randomTimeSlot = timeSlots[Math.floor(Math.random() * timeSlots.length)];
        const today = new Date();
        const tomorrow = new Date(today);
        tomorrow.setDate(tomorrow.getDate() + 1);
        const appointmentDate = tomorrow.toLocaleDateString('en-IN', { weekday: 'long', year: 'numeric', month: 'long', day: 'numeric' });


        toast({
            variant: "success",
            title: "Booking Confirmed!",
            description: `Your token number is ${tokenNumber}. Please visit ${doctor.hospital} on ${appointmentDate} at ${randomTimeSlot}.`,
            duration: 9000,
        });
    }
          ...
          <AlertDialog>
            ...
            {selectedDoctor?.name === doctor.name && (
                ...
                <AlertDialogHeader>
                    ...
                    <AlertDialogDescription>
                    You are about to book a token for an in-person visit with {doctor.name} at {doctor.hospital}. Please confirm.
                    </AlertDialogDescription>
                </AlertDialogHeader>
                <AlertDialogFooter>
